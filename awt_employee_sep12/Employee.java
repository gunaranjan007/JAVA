...
class Employee_details extends JFrame
{
	...
	private JTextField tf1,tf2,tf3;//tf3 for monthly loan amount
	...
	{
		//if loan is there move to private class () for loan calculations 
	...
	{
		int deduct =deductions(empBasicPay);
		int gross=grossSalary(empBasicPay);
		int netSalary=gross-deduct;
		...
		System.out.print("Do you have loan (yes/no) :"); //checking whether the Employee has loan or not 
		...
		System.out.println("-------------------------------------" );
		System.out.printf("TOTAL DETECTIONS  =%17d\n",deduct-loanAmount); //calling deduction method 
		System.out.println("-------------------------------------" );
		
		
		System.out.println("-------------------------------------" );
		System.out.println("Total Net Salary is equal to = " +( netSalary-loanAmount));  //Netsalary =gross-duductions 
		System.out.println("-------------------------------------" );
	...
	private class LoanCalculation implements ActionListener   //created to check the monthly laon due
	{
		public void actionPerformed(ActionEvent event)
		{
			...
			{
				loanAmount = loanAmt * Interest / 100;
